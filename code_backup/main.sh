...
ssh -o "StrictHostKeyChecking=no" -i /home/shukla_chandan64/code/keyfiles/privatekey.pem adhoc-vm "echo Adding Keys in Host"

#########################prepare hostlist for ansible
echo -e "[adhoc-vm]\nadhoc-vm ansible_ssh_private_key_file=/home/shukla_chandan64/code/keyfiles/privatekey.pem\n[runner-vm]\nrunner-vm ansible_ssh_private_key_file=/home/shukla_chandan64/code/keyfiles/privatekey.pem" > ./ansible_playbooks/ansible_host
cat /etc/hosts
cat ./ansible_playbooks/ansible_host
sleep 10s
ansible-playbook /home/shukla_chandan64/code/ansible_playbooks/pipinstall.yaml -i ./ansible_playbooks/ansible_host
ansible-playbook /home/shukla_chandan64/code/ansible_playbooks/install-python-packages.yaml -i ./ansible_playbooks/ansible_host
...
> ./terraform.tfstate
terraform apply -auto-approve /home/shukla_chandan64/code/restore_from_image 
